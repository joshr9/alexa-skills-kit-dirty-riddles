...
DirtyRiddle.prototype.eventHandlers.onSessionStarted = function (sessionStartedRequest, session) {
    console.log("DirtyRiddle onSessionStarted requestId: " + sessionStartedRequest.requestId
    + ", sessionId: " + session.sessionId);
    // any initialization logic goes here
};

DirtyRiddle.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    console.log("DirtyRiddle onLaunch requestId: " + launchRequest.requestId
    + ", sessionId: " + session.sessionId);
    handleDirtyRiddleRequest(response);
};
...
DirtyRiddle.prototype.eventHandlers.onSessionEnded = function (sessionEndedRequest, session) {
    console.log("DirtyRiddle onSessionEnded requestId: " + sessionEndedRequest.requestId
    + ", sessionId: " + session.sessionId);
    // any cleanup logic goes here
};

DirtyRiddle.prototype.intentHandlers = {
    "DirtyRiddle": function (intent, session, response) {
      var speechOutput = "Here it comes!"
        handleDirtyRiddleRequest(response);
    },
 ...
 */
function handleDirtyRiddleRequest(response) {
